    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                paddingTop: "20px", paddingBottom: "12px", paddingRight: "20px", paddingLeft: "20px",
                borderBottom: "2px solid rgba(30, 60, 114, 0.1)", width: "100%", boxSizing: "border-box"
            }}>
                <div>
            ...
            <div style={{
                ...
                paddingTop: "18px", paddingBottom: "18px", paddingRight: "20px", paddingLeft: "20px",
                ...
                <div style={{
                    ...
                    border: "1px solid rgba(30, 60, 114, 0.05)", transition: "all 0.3s", cursor: "pointer"
                }}
                    onMouseEnter={(e) => {
            ...
            {/* FORM */}
            <div style={{
                padding: "16px 20px", background: "linear-gradient(135deg, #ffffff 0%, #f8fafb 100%)",
                borderTop: "1px solid rgba(30, 60, 114, 0.05)", borderBottom: "1px solid rgba(30, 60, 114, 0.05)",
                width: "100%", boxSizing: "border-box", boxShadow: "0 4px 12px rgba(30, 60, 114, 0.06)"
            }}>
                ...
                <form onSubmit={handleAddTransaction} style={{
                    display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", marginBottom: "10px"
                }}>
                    <div>
            ...
            {/* DANH SÁCH */}
            <div style={{ paddingLeft: "20px", paddingRight: "20px", paddingTop: "18px", paddingBottom: "20px", flex: 1, width: "100%", boxSizing: "border-box" }}>
